...
import { Observable, combineLatest, concat, concatMap, exhaustMap, filter, fromEvent, map, mergeMap, of, shareReplay, switchMap } from 'rxjs';
...
export class Observables1Component implements OnInit {
 ...
 ngOnInit(){
  ...
  saveChanges$.pipe(
    ...
    switchMap(changes => this.saveChanges(changes))).subscribe(data => console.log(data)
